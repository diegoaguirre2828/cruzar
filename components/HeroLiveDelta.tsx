  ...
  return (
    <div className="mt-3 relative">
      ...
      {/* Compact share strip — was a full-size "Corre la voz" card that
          ...
          / Copy) because FB groups are still the growth vector, but
          1/4 the visual weight. */}
      <div className="mt-2 flex items-center justify-between gap-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl px-3 py-2">
        <p className="text-[11px] font-bold text-gray-600 dark:text-gray-300 leading-tight flex items-center gap-1.5 min-w-0">
          <span className="text-base">🤝</span>
          <span className="truncate">{es ? 'Avísale a tu gente' : 'Tell your people'}</span>
        </p>
        <div className="flex items-center gap-1.5 flex-shrink-0">
          <a
            ...
            aria-label="Facebook"
            className="w-9 h-9 flex items-center justify-center rounded-full bg-[#1877f2] text-white active:scale-90 transition-transform"
          >
          ...
          <a
            ...
            aria-label="WhatsApp"
            className="w-9 h-9 flex items-center justify-center rounded-full bg-[#25d366] text-white active:scale-90 transition-transform"
          >
          ...
          <button
            ...
            aria-label={es ? 'Copiar' : 'Copy'}
            className="w-9 h-9 flex items-center justify-center rounded-full bg-gray-900 dark:bg-gray-600 text-white active:scale-90 transition-transform text-sm font-black"
          >
            {copied ? '✓' : '🔗'}
          </button>
        </div>
